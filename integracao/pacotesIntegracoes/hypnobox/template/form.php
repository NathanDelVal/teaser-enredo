        ...
        <?php foreach($formConfiguracoes as $i => $form): ?>
            <div class="tab-pane fade <?php if($i == 0): ?>show active<?php endif; ?>" id="nav-<?= $form ?>-<?= $integracao ?>" role="tabpanel" aria-labelledby="nav-<?= $form ?>-tab-<?= $integracao ?>">
                ...
                <?php if($form == 'geral'): ?>
                    ...
                    <div class="row">
                        ...
                        <div class="form-check form-switch mb-3" style="margin-left: 20px;">
                            <input class="form-check-input" type="checkbox" name="<?= $form ?>-status" value="true" <?php if($hypnoboxConfiguracoes[$form]['status'] == true): ?>checked <?php endif ?> >
                            <label class="form-check-label">Status</label>
                        </div>

                        <div class="mb-3 col-4 form-floating">
                            <input list="hypnobox-<?= $form ?>-url-list" type="text" name="<?= $form ?>-url" class="form-control" value="<?= $hypnoboxConfiguracoes[$form]['url'] ?>" placeholder="url">
                            <label>url</label>
                        </div>

                        <datalist id="hypnobox-geral-url-list">
                            <option value="https://gafisa.hypnobox.com.br/email.receber.php">
                                https://gafisa.hypnobox.com.br/email.receber.php
                            </option>
                            <option value="https://mozak.hypnobox.com.br/email.receber.php">
                                https://mozak.hypnobox.com.br/email.receber.php
                            </option>
                        </datalist>

                        <div class="mb-3 col-4 form-floating">
                            <input type="text" name="<?= $form ?>-midia" class="form-control" value="<?= $hypnoboxConfiguracoes[$form]['midia'] ?>" placeholder="midia">
                            <label>Midia</label>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="mb-3 col-4 form-floating">
                        <input type="text" name="<?= $form ?>-idProduto" class="form-control" value="<?= $hypnoboxConfiguracoes[$form]['idProduto'] ?>" placeholder="idProduto">
