            ...
            <div class="tab-pane fade <?php if($i == 0): ?>show active<?php endif; ?>" id="nav-<?= $form ?>-<?= $integracao ?>" role="tabpanel" aria-labelledby="nav-<?= $form ?>-tab-<?= $integracao ?>">
                ...
                <?php if($form == 'geral'): ?>
                    ...
                    <div class="row">
                        ...
                        <div class="form-check form-switch mb-3" style="margin-left: 20px;">
                            <input class="form-check-input" type="checkbox" name="<?= $form ?>-status" value="true" <?php if($novocrmConfiguracoes[$form]['status'] == true): ?>checked <?php endif ?> >
                ...
                <div class="row">
                    ...
                    <div class="mb-3 col-4 form-floating">
                        <input type="text" name="<?= $form ?>-id" class="form-control" value="<?= $novocrmConfiguracoes[$form]['id'] ?>" placeholder="Id">
                        <label >Id</label>
                    </div>
