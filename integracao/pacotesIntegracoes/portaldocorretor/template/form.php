            ...
            <div class="tab-pane fade <?php if($i == 0): ?>show active<?php endif; ?>" id="nav-<?= $form ?>-<?= $integracao ?>" role="tabpanel" aria-labelledby="nav-<?= $form ?>-tab-<?= $integracao ?>">
                ...
                <?php if($form == 'geral'): ?>
                    ...
                    <div class="row">
                        ...
                        <div class="form-check form-switch mb-3" style="margin-left: 20px;">
                            <input class="form-check-input" type="checkbox" name="<?= $form ?>-status" value="true" <?php if($portaldocorretorConfiguracoes[$form]['status'] == true): ?>checked <?php endif ?> >
                            <label class="form-check-label">Status</label>
                        </div>

                        <!--
                        https://portal.descomplicavendas.com.br/api/leads/send
                        https://volendam.descomplicavendas.com.br/api/leads/send
                        -->
                        <?php foreach(['url', 'token'] as $campo): ?>
                            <div class="mb-3 col-4 form-floating">
                                <input list="portalcorretor-<?= $form ?>-<?= $campo ?>-list" type="text" name="<?= $form ?>-<?= $campo ?>" class="form-control" value="<?= $portaldocorretorConfiguracoes[$form][$campo] ?>" placeholder="<?= $campo ?>">
                                <label><?= $campo ?></label>
                            </div>
                        <?php endforeach; ?>

                        <datalist id="portalcorretor-geral-url-list">
                            <option value="https://portal.descomplicavendas.com.br/api/leads/send">
                                https://portal.descomplicavendas.com.br/api/leads/send
                            </option>
                            <option value="https://volendam.descomplicavendas.com.br/api/leads/send">
                                https://volendam.descomplicavendas.com.br/api/leads/send
                            </option>
                            <option value="https://homologvolendam.descomplicavendas.com.br/api/leads/send">
                                https://homologvolendam.descomplicavendas.com.br/api/leads/send
                            </option>
                        </datalist>
                ...
                <?php else: ?>
                    ...
                    <div class="row">
                        ...
                        <div class="mb-3 col-4 form-floating">
                            <input type="text" name="<?= $form ?>-group" class="form-control" value="<?= $portaldocorretorConfiguracoes[$form]['group'] ?>" placeholder="group">
                            <label >Grupo</label>
                        </div>
