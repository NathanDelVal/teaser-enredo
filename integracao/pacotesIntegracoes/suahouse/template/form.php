            ...
            <?php if($form == 'geral'): ?>
                ...
                <div class="row">
                    ...
                    <div class="form-check form-switch mb-3" style="margin-left: 20px;">
                        <input class="form-check-input" type="checkbox" name="<?= $form ?>-status" value="true" <?php if($suahouseConfiguracoes[$form]['status'] == true): ?>checked <?php endif ?> >
                    ...
                    <?php foreach($campos as $campo): ?>
                        <div class="mb-3 col-3 form-floating">
                            <input type="text" name="<?= $form ?>-<?= $campo ?>" class="form-control" value="<?= $suahouseConfiguracoes[$form][$campo] ?>" placeholder="<?= $campo ?>">
                            <label><?= $campo ?></label>
                        </div>
                    <?php endforeach; ?>
