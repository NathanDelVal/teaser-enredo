    <h1 style="color: #007cb2; text-transform: capitalize;"> Dados Google Analytics 4: </h1><br>
    <h6> Selecione os formulários que deseja integrar com a <span style="color: #007cb2; text-transform: capitalize;">Google Analytics 4</span> e passe as Configurações! </h6>
                ...
                <?php if($form == 'geral'): ?>
                    ...
                    <div class="row">
                        ...
                        <div class="form-check form-switch mb-3" style="margin-left: 20px;">
                            <input class="form-check-input" type="checkbox" name="<?= $form ?>-status" value="true" <?php if($ga4Configuracoes[$form]['status'] == true): ?>checked <?php endif ?> >
                            <label class="form-check-label">Status</label>
                        </div>

                        <div class="mb-3 col-4 form-floating">
                            <input type="text" name="<?= $form ?>-idGa4" class="form-control" value="<?php if($ga4Configuracoes[$form]['idGa4'] !== ""){ echo $ga4Configuracoes[$form]['idGa4']; }else{ echo "G-"; }?>" placeholder="">
                            <label >Id Ga4</label>
                        </div>
                ...
                <?php else: ?>
                    ...
                    <div class="row">
                     ...
                     <!--   <div class="form-check form-switch mb-3" style="margin-left: 20px;">
                        ...
                        <div class="mb-3 col-4 form-floating">
                            <input type="text" name="<?/*= $form */?>-event" id="trackFB" class="form-control" value="<?php /*echo ($ga4Configuracoes[$form]['event'] !== '' ? $ga4Configuracoes[$form]['event'] : 'SendLeed');  */?>" placeholder="event">
                            <label id="eventGTAG">event</label>
                        </div>

                        <div class="mb-3 col-4 form-floating">
                            <input type="text" name="<?/*= $form */?>-event_category" id="event_categoryGTAG" class="form-control" value="<?/*= $ga4Configuracoes[$form]['event_category'] */?>" placeholder="event_category">
                            <label id="event_categoryGTAG">event_category</label>
                        </div>

                        <div class="mb-3 col-4 form-floating">
                            <input type="text" name="<?/*= $form */?>-event_label" id="event_labelGTAG" class="form-control" value="<?/*= $ga4Configuracoes[$form]['event_label'] */?>" placeholder="event_label">
